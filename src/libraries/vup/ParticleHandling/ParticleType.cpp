...
//
//float vup::ParticleType::getIntConstant(std::string name)
//{
//  if (doesKeyExist(name, m_iConsts)) {
//    return m_iConsts.at(name);
//  }
//  return 0;
//}
//
...
vup::datavalue vup::ParticleType::getData(std::string name)
{
  ...
  return std::pair<vup::DataSpecification, std::string>(t, "");
}
